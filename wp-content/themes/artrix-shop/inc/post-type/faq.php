...
function suma_faq_post_type()
{
    ...
    $args = array(
        ...
        // 'rewrite'               => array('slug' => 'company/company-news'),
    );
    register_post_type('faq', $args);
}
add_action('init', 'suma_faq_post_type', 0);
...
function faq_taxonomy()
{
    ...
    $labels = array(
        ...
        'singular_name'              => _x('faq', 'Category Singular Name', 'text_domain'),
